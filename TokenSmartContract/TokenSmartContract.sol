...
contract MintableToken is StandardToken, Ownable {
    ...
    function mint(address _to, uint256 _amount) onlyOwner canMint public returns (bool) {
        require(totalSupply_.add(_amount) <= (1200000000 * (10 ** uint256(18))), "TotalSupply should not be more than INITIAL_SUPPLY");
...
contract Consts {
    string constant TOKEN_NAME = "ProjectWITH";
    string constant TOKEN_SYMBOL = "WKEN";
    uint8 constant TOKEN_DECIMALS = 18;
    uint256 constant TOKEN_AMOUNT = 1200000000;
